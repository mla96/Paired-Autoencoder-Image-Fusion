...
model_base_name = "CIFARjpeg_autoencoder_tanh_norm_trainable_color"

# Training parameters
model_architecture = "Res34"  # Options: noRes, Res34
epoch_num = 150
train_data_type = ""  # Options: None, AMDonly
...
unlabeled_dataset = ImbalancedDataset(data_paths, transformations=transformation_pipeline, augmentations=augmentation_pipeline)
